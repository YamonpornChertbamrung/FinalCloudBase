                    ...
                    <tr v-if="info.userStatus === 'false'">
                      ...
                      <td>
                        <div class="text-center">
                          ...
                          <button class="btn btn-success btn-sm " @click="changeStatus(info.userId)">อนุมัติ</button>
                        </div>
                      </td>
                    </tr>
                  </tbody>
...
export default {
  ...
  methods: {
    getUsers() {
      axios
        .get("https://xzd0nvjr64.execute-api.us-east-1.amazonaws.com/admin/reject")
        .then(response => {
