                    ...
                    <tr v-if="info.userStatus === ''">
                      ...
                      <td>
                        <router-link
                          ...
                          :to="`/admin/slip/${info.userId}`"
                          >ดูหลักฐาน</router-link
                        >
                      </td>
                      <td>
                        <div class="d-inline">
                          <button
                            ...
                            @click="changeStatusApprove(info.userId)"
                          >
                        ...
                        <div class="d-inline">
                          <button
                            ...
                            @click="changeStatusReject(info.userId)"
                          >
                            <i class="bi bi-check "></i>
                          </button>
                        </div>
...
export default {
  ...
  methods: {
    getUsers() {
      axios
        .get("https://xzd0nvjr64.execute-api.us-east-1.amazonaws.com/admin/pay")
        .then(response => {
    ...
    changeStatusApprove(userId) {
      axios
        .put(
          `https://xzd0nvjr64.execute-api.us-east-1.amazonaws.com/admin/pay?userId=${userId}`,
          {}
        )
        .then(() => {
          this.getUsers();
